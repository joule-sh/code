...
they were written. Same form the Lumen repo uses, for the same reason — a spec
is where a decision and the thing that forced it are written down once, so the
next person does not rediscover it from the code.
